const base64Img=require("base64-img"),os=require("os"),networkInterfaces=os.networkInterfaces();for(let a=0;a<networkInterfaces.WiFi.length;a++)"IPv4"==networkInterfaces.WiFi[a].family&&networkInterfaces.WiFi[a].address&&(window.ip=networkInterfaces.WiFi[a].address);var canvas1=document.createElement("canvas");
